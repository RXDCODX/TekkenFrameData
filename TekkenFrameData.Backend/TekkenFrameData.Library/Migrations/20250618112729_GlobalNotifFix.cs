...
public partial class GlobalNotifFix : Migration
{
    ...
    {
        migrationBuilder.DropColumn(name: "TwitchId", table: "GlobalNotificatoinChannelsState");
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropColumn(name: "ChannelId", table: "GlobalNotificatoinChannelsState");
